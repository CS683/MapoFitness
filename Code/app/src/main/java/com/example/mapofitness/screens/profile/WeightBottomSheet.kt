...
@Composable
fun WeightBottomSheet(onDismiss: () -> Unit, viewModel: PersonalInfoViewModel) {
    var sliderPosition by remember { mutableStateOf(UserManager.getWeight() ?: 100f) }
...
private fun onSave(weight: Float, viewModel: PersonalInfoViewModel, onDismiss: () -> Unit) {
